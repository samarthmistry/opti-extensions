...
"""Shared data fixtures for functional tests.

These fixtures provide the problem data (index-sets, parameters, expected solutions)
used across all solver-specific functional tests for the diet and multicommodity problems.
"""
...
@pytest.fixture()
def diet_data():
    """Return all index-sets and parameters for the diet problem."""
...
@pytest.fixture()
def multicommodity_data():
    """Return all dataframes, index-sets, and parameters for the multicommodity problem."""
    df_supply = (
        pd.DataFrame(
            {
